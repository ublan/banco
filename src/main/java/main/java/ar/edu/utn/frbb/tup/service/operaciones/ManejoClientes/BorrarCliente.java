...
public class BorrarCliente {
    ...
    public ResponseEntity<String> borrarCliente(String dni) {
        ...
        try (BufferedReader lector = new BufferedReader(new FileReader(NOMBRE_ARCHIVO))) {
            ...
            e.printStackTrace();
            return new ResponseEntity<>("Error al intentar leer el archivo de clientes", HttpStatus.INTERNAL_SERVER_ERROR);
        }
        ...
        if (clienteEncontrado) {
            try (BufferedWriter escritor = new BufferedWriter(new FileWriter(NOMBRE_ARCHIVO))) {
                ...
                e.printStackTrace();
                return new ResponseEntity<>("Error al intentar escribir en el archivo de clientes", HttpStatus.INTERNAL_SERVER_ERROR);
            }
        } else {
