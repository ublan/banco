...
public class Deposito {
    ...
    public static void depositar() {
        ...
        try {
            ...
            while (CbuValidado == null) {
                System.out.println("Ingresar el CBU al que desea depositar: ");
            ...
            SummitMovimientos.registrarMovimiento(CbuValidado, monto, TIPO_MOVIMIENTO);
        } finally {
    ...
    public static void sobreescribirCuentaDeposito(String CbuValidado, double monto) {
